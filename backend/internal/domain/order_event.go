...
type OrderEvent struct {
	...
	GrossAmountOut  string    `gorm:"type:numeric(78,0);not null;default:'0'"`
	RecipientAmountOut string `gorm:"type:numeric(78,0);not null;default:'0'"`
	ExecutorFeeAmount string  `gorm:"type:numeric(78,0);not null;default:'0'"`

...
const (
	Executor_Ping_FullMethodName            = "/executor.Executor/Ping"
	...
	Executor_ApplyOrderEvent_FullMethodName = "/executor.Executor/ApplyOrderEvent"
...
func (c *executorClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, Executor_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executorClient) ApplyOrderEvent(ctx context.Context, in *ApplyOrderEventRequest, opts ...grpc.CallOption) (*ApplyOrderEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApplyOrderEventResponse)
	err := c.cc.Invoke(ctx, Executor_ApplyOrderEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExecutorServer interface {
	...
	ApplyOrderEvent(context.Context, *ApplyOrderEventRequest) (*ApplyOrderEventResponse, error)
...
func (UnimplementedExecutorServer) ApplyOrderEvent(context.Context, *ApplyOrderEventRequest) (*ApplyOrderEventResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyOrderEvent not implemented")
}
...
func _Executor_ApplyOrderEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyOrderEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecutorServer).ApplyOrderEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Executor_ApplyOrderEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).ApplyOrderEvent(ctx, req.(*ApplyOrderEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Executor_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ApplyOrderEvent",
			Handler:    _Executor_ApplyOrderEvent_Handler,
		},
		{
			MethodName: "GetOrder",
